...
function spiralTraversal(matrix) {
    ...
    var columns = matrix[0].length; // columns = the total number of columns in the input
    ...
    var rowRight = function (r, c, ec) {
        ...
        rc++;
        rR++;
        if (rc === rows || cc === columns) {
            return;
        } //done traversing (if you have either seen every row or every column)
